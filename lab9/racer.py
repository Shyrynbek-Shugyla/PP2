...
background = pygame.image.load(r"C:\Users\Admin\Desktop\pp2\lab8\assigment1\street.png")
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load(r"C:\Users\Admin\Desktop\pp2\lab8\assigment1\enemy.png")
...
class Coin(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load(r"C:\Users\Admin\Desktop\pp2\lab8\assigment1\coin.png")
        self.image = pygame.transform.scale(self.image, (40, 40))
        self.rect = self.image.get_rect()
        self.value = random.choice([1, 2, 3])  # Случайный вес монеты
    ...
    def move(self):
        ...
        # При сборе монеты увеличиваем счёт на её "вес"
        COINS += self.value

        # Увеличиваем скорость врага при достижении определённых монет
        ...
        # После сбора монета возрождается и получает новый вес
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load(r"C:\Users\Admin\Desktop\pp2\lab8\assigment1\player.png")
        self.rect = self.image.get_rect()
